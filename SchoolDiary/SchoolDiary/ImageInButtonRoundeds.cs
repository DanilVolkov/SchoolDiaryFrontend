...
namespace SchoolDiary
{
    public class ImageInButtonRoundeds
    {
        ...
        public static void GroupSheduleGrade(ButtonShedule buttonShedule, ButtonGrade buttonGrade)
        {
            ...
            buttonShedule.Size = new Size(48, 48);
            buttonGrade.Size = new Size(48, 48);
            buttonShedule.BackgroundImage = Image.FromFile("../../ImageButtons/button_manu_close_schedule_default.png");
            buttonGrade.BackgroundImage = Image.FromFile("../../ImageButtons/button_menu_close_mark_defoult.png");
        }
